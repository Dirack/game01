package com.rsgaming.world;

import com.rsgaming.entities.*;
            ...
            for (int xx = 0; xx < map.getWidth(); xx++){
                for (int yy = 0; yy < map.getHeight(); yy++){
                    ...
                    if( pixelsAtual == 0xFF000000 ){
                        ...
                        //LIFE_POTIONS
                        Game.entities.add(new Potions(xx*16, yy*16, 16,16, Entity.LIFEPOTION_EN));
                    }else if(pixelsAtual == 0xFF00FFFF) {
                        //mana_POTIONS 00FFFF
                        Game.entities.add(new ManaPotion(xx*16, yy*16, 16,16, Entity.MANAPOTION_EN));
                    }else if (pixelsAtual == 0xFFFFD800){
                        //WEAPONSWORD1
                        Game.entities.add(new Weapon(xx*16, yy*16, 16,16, Entity.WEAPON_SWORD_EN));
